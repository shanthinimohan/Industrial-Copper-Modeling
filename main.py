...
if submit_button and flag == 0:
    ...
    with open(r"D:\python\copper_modelling/model.pkl", 'rb') as file:
        loaded_model = pickle.load(file)
    with open(r"D:\python\copper_modelling/scaler.pkl", 'rb') as f:
        scaler_loaded = pickle.load(f)

    with open(r"D:\python\copper_modelling/t.pkl", 'rb') as f:
        t_loaded = pickle.load(f)

    with open(r"D:\python\copper_modelling/s.pkl", 'rb') as f:
        s_loaded = pickle.load(f)

    new_sample = np.array([[np.log(float(quantity_tons)), application, np.log(float(thickness)), float(width), country,
                            float(customer), int(product_ref), item_type, status]])
    ...
    new_pred = scaler_loaded.transform(new_sample1)
...
with tab2:
    ...
    if csubmit_button and cflag == 0:
        ...
        with open(r"D:\python\copper_modelling/cmodel.pkl", 'rb') as file:
            cloaded_model = pickle.load(file)

        with open(r"D:\python\copper_modelling/cscaler.pkl", 'rb') as f:
            cscaler_loaded = pickle.load(f)

        with open(r"D:\python\copper_modelling/ct.pkl", 'rb') as f:
        ...
        new_pred = cscaler_loaded.transform(new_sample1)
        if new_pred == 1:
